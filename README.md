...
I'm a **research software engineer**: I build **bare-metal, high-performance systems** and use them
as instruments to investigate hard problems. CUDA, Rust and C/C++ where latency and control decide
the outcome; Python where it pays. AI runs through it both ways — I build the systems that *run*
models, and I build *with* models (neural-guided annealers, compile-time-safe neural interfaces,
forecasting control loops). Solo, end to end, on bare metal (Arch Linux, CUDA-first) — with
...
materials, energy — are the proving grounds where I point the same skill, *not what I am*. I'm not a
neuroscientist or a materials physicist; I'm the engineer who builds the systems that let me
investigate them at the metal, and who cares enough to get the physics right and the numbers honest.
The through-line: *physics computes by minimizing energy; I write the systems that exploit it.*
